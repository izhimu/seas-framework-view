...
- **[@izhimu/seas-core](./core/seas-core.md)** - Core functionality library with HTTP client, authentication, encryption, and composables
- **[@izhimu/seas-common](./core/seas-common.md)** - Common utilities library with helpers for strings, numbers, dates, validation, and more
- **[@izhimu/seas-mobile-core](./core/seas-mobile-core.md)** - Mobile-specific core library with device detection, touch gestures, and mobile components
...
- **[@izhimu/seas-base-view](./packages/seas-base-view.md)** - Base UI components and layouts for desktop applications
- **[@izhimu/seas-security-view](./packages/seas-security-view.md)** - Security components including authentication, user management, and access control

### Data & AI

- **[@izhimu/seas-ai-view](./packages/seas-ai-view.md)** - AI integration components with chat interfaces, prompt management, and AI-assisted features

### Storage & Communication

- **[@izhimu/seas-storage-view](./packages/seas-storage-view.md)** - Storage management with file uploads, downloads, and organization
- **[@izhimu/seas-mqtt-view](./packages/seas-mqtt-view.md)** - MQTT messaging components for real-time communication and IoT

### System & Tools

- **[@izhimu/seas-job-view](./packages/seas-job-view.md)** - Job scheduling and task management components
- **[@izhimu/seas-healthy-view](./packages/seas-healthy-view.md)** - Health monitoring and diagnostics components
- **[@izhimu/seas-generate-view](./packages/seas-generate-view.md)** - Code generation tools and templates
- **[@izhimu/seas-form-view](./packages/seas-form-view.md)** - Form building and validation components
