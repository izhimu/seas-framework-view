<template>
  ...
  <n-form-item label="显示属性">
    <n-space item-style="display: flex;" align="center">
      <n-checkbox v-model:checked="data.options.block">块级 </n-checkbox>
      <n-checkbox v-model:checked="data.options.bordered">显示边框 </n-checkbox>
      <n-checkbox v-model:checked="data.options.dashed">虚线边框 </n-checkbox>
      <n-checkbox v-model:checked="data.options.circle">圆形 </n-checkbox>
      <n-checkbox v-model:checked="data.options.ghost">透明 </n-checkbox>
      <n-checkbox v-model:checked="data.options.strong">文字加粗 </n-checkbox>
      <n-checkbox v-model:checked="data.options.textBtn">文本按钮 </n-checkbox>
    </n-space>
  </n-form-item>
  <n-form-item>
    <template #label>
    ...
    <n-grid x-gap="2" :cols="3">
      ...
      <n-gi>
        <n-form-item label="文字" path="textColor">
          <n-color-picker
            v-model:value="data.options.textColor"
            :modes="['hex']"
          />
        </n-form-item>
      </n-gi>
  ...
  <n-form-item label="操作属性">
    ...
    <n-checkbox v-model:checked="data.options.loading">加载状态 </n-checkbox>
  </n-form-item>
</template>
<script lang="ts">
