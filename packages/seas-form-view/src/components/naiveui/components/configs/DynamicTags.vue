<template>
    ...
    <n-grid x-gap="2" :cols="4">
      <n-gi>
        <n-form-item label="背景" path="color">
          <n-color-picker
            v-model:value="data.options.color.color"
            :modes="['hex']"
          />
        </n-form-item>
      </n-gi>
      <n-gi>
        <n-form-item label="边框" path="borderColor">
          <n-color-picker
            v-model:value="data.options.color.borderColor"
            :modes="['hex']"
          />
        </n-form-item>
      </n-gi>
      <n-gi>
        <n-form-item label="文字" path="textColor">
          <n-color-picker
            v-model:value="data.options.color.textColor"
            :modes="['hex']"
          />
        </n-form-item>
      </n-gi>
  ...
  <n-form-item label="显示属性">
    ...
    <n-checkbox v-model:checked="data.options.closable">允许关闭 </n-checkbox>
  </n-form-item>
