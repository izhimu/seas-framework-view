<template>
  <n-form-item label="模式">
    <n-radio-group v-model:value="data.options.listType" button-style="solid">
  ...
  <n-form-item label="上传请求方法">
    <n-radio-group v-model:value="data.options.method" button-style="solid">
  ...
  <n-form-item label="上传属性">
    <n-space item-style="display: flex;" align="center">
      <n-checkbox v-model:checked="data.options.showFileList"
        >显示列表</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.multiple">多选</n-checkbox>
      <n-checkbox v-model:checked="data.options.defaultUpload"
        >否默认上传</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.directory">目录上传</n-checkbox>
      <n-checkbox v-model:checked="data.options.directoryDnd"
        >目录拖拽上传</n-checkbox
      >
    </n-space>
  </n-form-item>
  <n-form-item label="操作属性">
    <n-space item-style="display: flex;" align="center">
      <n-checkbox v-model:checked="data.options.showDownloadButton"
        >显示下载按钮</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.showRetryButton"
        >显示重新上传按钮</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.showRemoveButton"
        >显示删除按钮</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.showCancelButton"
        >是否显示取消按钮</n-checkbox
      >
      <n-checkbox v-model:checked="data.options.showPreviewButton"
        >是否允许显示预览按钮</n-checkbox
      >
    </n-space>
  </n-form-item>
