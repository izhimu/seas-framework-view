  ...
  <div class="form-config-container">
    <n-form>
      ...
      <n-form-item label="标签显示位置">
        <n-radio-group
          v-model:value="data.labelPlacement"
          button-style="solid"
          @change="changeLabelPlacement"
        >
      ...
      <n-form-item label="标签宽度">
        <n-radio-group
          v-model:value="labelWidthType"
          button-style="solid"
          @change="changeLabelWidthType"
        >
          <n-radio-button
            value="auto"
            :disabled="data.labelPlacement === 'left'"
            >自动</n-radio-button
          >
          <n-radio-button
            value="custom"
            :disabled="data.labelPlacement === 'top'"
            >自定义</n-radio-button
          >
        </n-radio-group>
        <n-input-number
          v-if="labelWidthType === 'custom'"
          v-model:value="data.labelWidth"
        />
      </n-form-item>
